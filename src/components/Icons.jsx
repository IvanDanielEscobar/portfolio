// Iconos SVG nativos ultraligeros y estilizados para el portafolio
// Zero dependencias externas para garantizar builds 100% autónomos y rápidos
...
export function IconNetwork({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4m-7 4l5-2m9 2l-5-2" />
    </svg>
  );
}
